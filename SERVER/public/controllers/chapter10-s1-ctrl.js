app.controller('codeCtrlC10S1', function($scope, $http) {
    ...
    $scope.q1options = [
        ...
        { text: "0", hints: "cumulative sum", correct: 0, type: "mc" },
    ...
    $scope.q3options = [
        { text: "0", hints: "complete the for loop; it isn’t terminated by the first false “if”", correct: 0, type: "mc" },
        { text: "1", hints: "count not created as array.", correct: 0, type: "mc" },
        { text: "[0 1 2]", hints: "", correct: 1, type: "mc" },
        { text: "3", hints: "count not created as array.", correct: 0, type: "mc" },
    ]
    ...
    $scope.q5options = [
        { text: "16", hints: "var1 is asked for, not var2", correct: 0, type: "mc" },
        { text: "[8 14 10]", hints: "unspecified array locations are filled with zeros", correct: 0, type: "mc" },
        { text: "[8 15 14 7 10]", hints: "index variable increments by 2s", correct: 0, type: "mc" },
